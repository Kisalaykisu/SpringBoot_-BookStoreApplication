package com.example.springboot_bookstoreapplication.controller;

import com.example.springboot_bookstoreapplication.dto.LoginDTO;
import com.example.springboot_bookstoreapplication.dto.ResponseDTO;
...
import com.example.springboot_bookstoreapplication.service.UserService;
...
//    }
    ...
    public ResponseEntity<String>getUserDetails(@PathVariable String token){
        ...
        ResponseDTO respDTO = new ResponseDTO("Data retrieved successfully for the ID: "+Userid, String.valueOf(userData));
    ...
    public ResponseEntity<ResponseDTO> getAllUserDetails(){
        ...
        ResponseDTO responseDTO = new ResponseDTO("All User Details, total count: "+ userDetailsList.size(), userDetailsList.toString());
    ...
    public ResponseEntity<ResponseDTO> getUserById(@PathVariable Long id){
        ...
        ResponseDTO responseDTO = new ResponseDTO("User Details with the ID: "+id, String.valueOf(userDetails));
        return new ResponseEntity<>(responseDTO, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseDTO> getUserByEmail(@PathVariable String email){
        ...
        ResponseDTO responseDTO = new ResponseDTO("User Details with the Email Address: "+email, String.valueOf(userDetails));
        return new ResponseEntity<>(responseDTO, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ResponseDTO> updateUserByEmailAddress(@PathVariable String email,@Valid @RequestBody UserDTO userDTO) {
        ...
        ResponseDTO respDTO= new ResponseDTO("Data Update info", String.valueOf(userData));
        return new ResponseEntity<>(respDTO, HttpStatus.OK);
    }
    ...
    public ResponseEntity <ResponseDTO> deleteUserDataByID(@PathVariable Long id) {
        ...
        ResponseDTO respDTO= new ResponseDTO("Deleted Successfully and e-mail sent, Below Data is deleted", String.valueOf(deletedData));
        return new ResponseEntity<>(respDTO, HttpStatus.OK);
    }
    //Login check
    @PostMapping("/login")
